...
\fancyhead[L]{
        \includegraphics[width=1cm]{usil.png}
}
% Portada
\thispagestyle{empty}
...
Recopilar, analizar e implementar distintas técnicas para la creación de mapas procedurales en videojuegos 2D. Se han utilizado algoritmos de pathfinding, que se caracterizan por su eficacia y eficiencia en la generación de rutas y caminos para los elementos del juego. Como complemento al algoritmo, se utilizó el algoritmo de Kruskal. Similar al pathfinding en el sentido de que se utiliza para generar árboles que superan el espacio mínimo, es decir el camino más corto, permitiendo establecer enlaces eficientes entre los diferentes elementos del mapa.
\subsection{Objetivos específicos} 
Estudiar y comprender los algoritmos de pathfinding utilizados para generar rutas y caminos para elementos de juego en mapas procedurales.
Analizar la eficacia y eficiencia de los algoritmos pathfinding y Kruskal en la generación de rutas y caminos para elementos de juego en mapas procedurales.
Utilizar el lenguaje de programación Python para implementar algoritmos en el desarrollo de videojuegos. 
Analizar las ventajas, desventajas y aplicaciones de los algoritmos de kruskal y pathfinding
...
En la recopilación de datos, se llevó a cabo una investigación exhaustiva que incluyó la revisión de papers y artículos relacionados con la generación procedural de mapas y la detección de colisiones en videojuegos. Durante esta etapa, se descartó el uso del algoritmo de "perlin noise" debido a que no se ajustaba a las necesidades específicas del proyecto. En su lugar, se optó por utilizar los algoritmos de "drunkard's walk" y  búsqueda en amplitud ("breadth first search"), ya que eran más adecuados para el desarrollo de juegos y cumplían con los objetivos establecidos. Además, se tuvo en cuenta los algoritmos de de pathfinding y Kruskal como los más relevantes para el desarrollo del proyecto. Para poner en marcha este proyecto se usó el lenguaje de programación Python para implementar estos algoritmos en el desarrollo de videojuegos.
\subsection{Análisis de datos:}
Después de recopilar los datos, se realizó un análisis detallado de los hallazgos más relevantes encontrados en los papers seleccionados. Este análisis permitió obtener una comprensión profunda de los conceptos teóricos y las técnicas asociadas con los algoritmos de pathfinding y Kruskal. Se examinaron los diferentes enfoques y se evaluaron sus ventajas y limitaciones en relación con los objetivos específicos del proyecto.

En el caso del pathfinding, se identificó la importancia de comprender y aplicar algoritmos eficientes para generar rutas y caminos para elementos de juego en mapas procedurales. Entre los algoritmos estudiados, se destacó el algoritmo de búsqueda en amplitud ("breadth first search") como una opción adecuada para el desarrollo de juegos 2D.

Por otro lado, en el análisis de Kruskal, se comprendió su utilidad en la generación de rutas y caminos en mapas procedurales, especialmente en la construcción de árboles de expansión mínima. Este algoritmo es ampliamente utilizado en la resolución de problemas de optimización y ha demostrado ser eficaz en la generación de estructuras de juego.
...
\begin{figure}
    \centering
    \caption{Implementación de algoritmo de Kruskal y Pathfinding}
    \includegraphics[width=0.5\textwidth]{Kruskal-_pathfinding.png}
    \label{fig:enter-label}
\end{figure}
Como resultado de la aplicación de estos algoritmos, logramos obtener un videojuego completamente funcional.
\begin{figure}
    \centering
    \caption{Resultado final}
    \includegraphics[width=0.8\textwidth]{Videojuego.png}
    \label{fig:enter-label}
\end{figure}

\newpage
\subsection{Conclusiones:}
En conclusión, este proyecto donde hicimos uso desde el diseño del estudios hasta la recopilación y análisis de datos, ha destacado la notable viabilidad y eficancia de la generación procedural de mapas, en particular, mediante la implementación exitosa de Kruskal y pathfinding, La integración de estas técnicas ha mostrado ser importante para superar los desafíos asociados con la creación automática de entornos de juego, brindando no solo eficiencia en el desarrollo, sino también una buena experiencia de juego para los usuarios.
